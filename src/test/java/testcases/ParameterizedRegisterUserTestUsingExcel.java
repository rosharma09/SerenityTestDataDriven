...
public class ParameterizedRegisterUserTestUsingExcel {
	...
	public ParameterizedRegisterUserTestUsingExcel(String title, String firstName, String lastName, String email,
